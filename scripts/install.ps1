...
function Get-LatestVersion {
    try {
        $latestRelease = Invoke-RestMethod -Uri "https://api.github.com/repos/suinian0309/cursorvip/releases/latest"
        return @{
...
Write-Host "Created by suinian0309`n" -ForegroundColor $Theme.Info
...
function Install-CursorVIP {
    Write-Styled "Start downloading Cursorvip" -Color $Theme.Primary -Prefix "Download"
